...
<div class="-container">
    ...
    <div class="quest-list">
        <div class="title">
            <div>Advisory - Question</div>
        </div>
        [{if $advisory_latest}]
        [{foreach from=$advisory_latest item=foo }]
        <div>
            <div><a href="/advisory/[{$foo->cat_alias|escape:'html'}]/[{$foo->advisory_id|escape:'html'}]"><b>[{$foo->advisory_title|escape:'html'}]</b></a></div>
            
            <div>
                <span class="date">
                    [{$foo->cat_title|escape:'html'}] - 
                    [{$foo->advisory_name|escape:'html'}] - 
                    [{$foo->advisory_publicday|date_format:"%a %d-%m, %Y"}] ✔
                </span>
            </div>
            <div></div>
