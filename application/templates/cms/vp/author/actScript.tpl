...
var _oConfig = {
    ...
    'cateType':'',
    'entryId': '',
    'entryBindingUri': base_url+'cms/vp/[{$tplConfig.controller}]/bindingbytype/',
    'entryEditUri': base_url+'cms/vp/[{$tplConfig.controller}]/editpanel/',
    'entryCommitUri': base_url+'cms/vp/[{$tplConfig.controller}]/onCommit/',
    'entryDeleteUri': base_url+'cms/vp/[{$tplConfig.controller}]/onDelete/'
};
