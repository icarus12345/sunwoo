    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div>
                ...
                <div>
                    {% if(o.label){ %}
                    Author : <code>{%=o.label%}</code>
                    {% } %}
                </div>
                <div>
                    {% if(o.video_publicday){ %}
                    Public at : {%=o.video_publicday%}
                    {% } %}
                </div>
                <p class="word-wrap line-clamp-3">{%=o.[{$tplConfig.prefix}]desc%}</p>
            </div>
        </div>
        [{if $unit}]
        <div class="action">
