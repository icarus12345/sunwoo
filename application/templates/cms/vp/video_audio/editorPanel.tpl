    ...
    <div class="widget full">
        ...
        <div class="modal-body">
            ...
            <form name="entryForm" id="entryForm" target="integration_asynchronous">
                        <div class="row">
                            <div class="col-mb-6" style="z-index:100">
                            ...
                            <div class="col-sm-6"> 
                                <div class="control-group pull-top">
                                    ...
                                    <input type="text" 
                                        ...
                                        name="video_title"
                                        maxlength="255" 
                                        onblur="AliasTo('#entryForm input[name=video_title]','#entryForm input[name=video_alias]')" 
                                        >
                                </div>
                            </div>
                            <div class="col-sm-6"> 
                                <div class="control-group pull-top">
                                    ...
                                    <input type="text" 
                                        ...
                                        name="video_alias" 
                                        value="[{$item->video_alias|escape|default:''}]"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
