...
var _CONFIG = {
    ...
    BINDING_URI 		: base_url + 'cms/co/event/widgetbinding/',
    EDITPANEL_URI 		: base_url + 'cms/co/event/editpanel/',
    COMMIT_URI 			: base_url + 'cms/co/event/onCommit/',
    DELETE_URI 			: base_url + 'cms/co/event/onDelete/',
...
var APP = function() {
    ...
    this.bindingUri = base_url + 'cms/co/event/widgetbinding/';
    this.editPanelUri = base_url + 'cms/co/event/editpanel/';
    this.entryCommitUri = base_url + 'cms/co/event/onCommit/';
    this.entryDeleteUri = base_url + 'cms/co/event/onDelete/';
    pendingOn();
    var me = this;
    this._datafields = [
