    ...
    _oConfig.dataColumns = [
        ...
        },
        {
            ...
            'mRender': function ( value, type, datarow ) {
                ...
                [{if $unit}]
                    ...
                    elm = 
                        '<span '+ 
                            'onclick="[{$tplConfig.name}].changeStatus('+status+',\'' + datarow.topic_id + '\')" '+
        ...
        },
        {
            ...
            'mRender': function ( value, type, datarow ) {
                ...
                var rowstr =  datarow.topic_title;
                if(datarow.author_name){
                    rowstr += '<span class="code" style="font-size:11px"> Author: '
                        + datarow.author_name
                        + '</span>';
                }
                return rowstr;
