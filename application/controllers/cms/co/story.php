...
class story extends VD_Controller {
    function __construct() {
        ...
        $this->assigns->tplConfig = array(
            ...
            'title'        =>'Story',
            'group'        =>'co',
            'listEntryTitle'=>'Story Manager',
            'addEntryTitle'=>'Add new Story',
            'editEntryTitle'=>'Modify Story',
            'entryListTpl'=>''
        );
    }
    ...
    function widget($unit='v-',$type=''){
        $this->assigns->tplConfig['entryListTpl'] = 'templates/cms/co/story/widget.tpl';
    ...
    function editpanel($type=''){
        $this->db->order_by('cat_value','ASC');
        $this->assigns->cates = $this->cate_model->onGetByType('story');
        $this->assigns->type=$type;
        $Id=$this->input->post('Id');
        ...
        $htmlreponse = $this->smarty->view( 'cms/co/story/editorPanel', $this->assigns, true );
        $output["result"] = 1;
