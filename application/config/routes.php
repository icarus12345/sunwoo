...
$route["blogs/([a-z0-9-]{4,255})"] = "frontend/news/detail/$1";
$route["blogs/page/([0-9]{1,3})"] = "frontend/news/cat/all/$1";
$route["blogs/page"] = "frontend/news";
$route["blogs"] = "frontend/news";
