...
$.extend( RowGroup.prototype, {
	...
	_rowWrap: function ( display, className )
	{
		...
		if (display!= null && typeof display === 'object' && display.nodeName && display.nodeName.toLowerCase() === 'tr') {
			row = $(display);
		}
		else if (display!= null && display instanceof $ && display.length && display[0].nodeName.toLowerCase() === 'tr') {
			row = display;
		}
		else {
			row = $('<tr/>')
